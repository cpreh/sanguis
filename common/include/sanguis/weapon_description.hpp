...
public:
  ...
  [[nodiscard]] SANGUIS_COMMON_SYMBOL sanguis::weapon_type const &weapon_type() const;

  [[nodiscard]] SANGUIS_COMMON_SYMBOL sanguis::magazine_size magazine_size() const;

  [[nodiscard]] SANGUIS_COMMON_SYMBOL sanguis::magazine_extra magazine_extra() const;

  [[nodiscard]] SANGUIS_COMMON_SYMBOL sanguis::magazine_remaining magazine_remaining() const;

  [[nodiscard]] SANGUIS_COMMON_SYMBOL sanguis::reload_time reload_time() const;

  [[nodiscard]] SANGUIS_COMMON_SYMBOL sanguis::weapon_attribute_vector const &attributes() const;
