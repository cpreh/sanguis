...
#define SANGUIS_MESSAGES_CLIENT_SERIALIZATION_INSTANTIATE_MESSAGE(msg) \
  ALDA_SERIALIZATION_INSTANTIATE_MESSAGE(sanguis::messages::client::types::alda_type, msg); \
  namespace \
  { \
\
