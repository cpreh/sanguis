#ifndef SANGUIS_MESSAGES_SERVER_ADD_DOODAD_HPP_INCLUDED
#define SANGUIS_MESSAGES_SERVER_ADD_DOODAD_HPP_INCLUDED

#include <sanguis/messages/adapted_types/doodad_type.hpp> // IWYU pragma: keep
#include <sanguis/messages/server/add_doodad_fwd.hpp> // IWYU pragma: export
...
SANGUIS_MESSAGES_SERVER_DECLARE_MESSAGE(sanguis::messages::server::add_doodad);
