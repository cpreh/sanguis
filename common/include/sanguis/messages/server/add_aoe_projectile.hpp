#ifndef SANGUIS_MESSAGES_SERVER_ADD_AOE_PROJECTILE_HPP_INCLUDED
#define SANGUIS_MESSAGES_SERVER_ADD_AOE_PROJECTILE_HPP_INCLUDED

#include <sanguis/aoe_projectile_type.hpp> // IWYU pragma: keep
...
#include <sanguis/messages/server/parts/speed.hpp> // IWYU pragma: keep
...
SANGUIS_MESSAGES_SERVER_DECLARE_MESSAGE(sanguis::messages::server::add_aoe_projectile);
