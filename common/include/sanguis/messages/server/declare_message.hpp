...
#define SANGUIS_MESSAGES_SERVER_DECLARE_MESSAGE(msg) \
  SANGUIS_MESSAGES_SERVER_SERIALIZATION_DECLARE_MESSAGE(msg); \
  ALDA_MESSAGE_DECLARE_CONCRETE(sanguis::messages::server::types::alda_type, msg)
