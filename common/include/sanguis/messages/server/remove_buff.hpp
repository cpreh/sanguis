#ifndef SANGUIS_MESSAGES_SERVER_REMOVE_BUFF_HPP_INCLUDED
...
#include <sanguis/messages/server/remove_buff_fwd.hpp> // IWYU pragma: export
...
SANGUIS_MESSAGES_SERVER_DECLARE_MESSAGE(sanguis::messages::server::remove_buff);
