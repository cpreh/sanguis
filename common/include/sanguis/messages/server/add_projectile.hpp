...
#include <sanguis/projectile_type.hpp> // IWYU pragma: keep
#include <sanguis/messages/adapted_types/enum.hpp> // IWYU pragma: keep
#include <sanguis/messages/server/add_projectile_fwd.hpp> // IWYU pragma: export
...
SANGUIS_MESSAGES_SERVER_DECLARE_MESSAGE(sanguis::messages::server::add_projectile);
