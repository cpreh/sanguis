...
sanguis::weapon_attribute_vector sanguis::messages::convert::from_weapon_attribute_vector(
    sanguis::messages::server::types::weapon_attribute_vector const &_attributes)
{
  return fcppt::algorithm::map<sanguis::weapon_attribute_vector>(
      _attributes,
      [](sanguis::messages::server::types::weapon_attribute const &_attribute)
      {
        return sanguis::weapon_attribute(
            _attribute.get<sanguis::messages::roles::weapon_attribute_type>(),
            sanguis::weapon_attribute_base(
                _attribute.get<sanguis::messages::roles::weapon_attribute_base>()),
            sanguis::weapon_attribute_extra(
                _attribute.get<sanguis::messages::roles::weapon_attribute_extra>()));
      });
}
