...
{
  return fcppt::algorithm::map<sanguis::messages::server::types::weapon_attribute_vector>(
      _attributes,
      [](sanguis::weapon_attribute const &_attribute)
      {
        return sanguis::messages::server::types::weapon_attribute(
            sanguis::messages::roles::weapon_attribute_type{} = _attribute.type(),
            sanguis::messages::roles::weapon_attribute_base{} = _attribute.base().get(),
            sanguis::messages::roles::weapon_attribute_extra{} = _attribute.extra().get());
      });
}
