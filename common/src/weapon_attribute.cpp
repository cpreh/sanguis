...
sanguis::weapon_attribute::weapon_attribute(
    ...
    : type_(_type), base_(_base), extra_(_extra)
{
}

sanguis::weapon_attribute_type sanguis::weapon_attribute::type() const { return type_; }

sanguis::weapon_attribute_base sanguis::weapon_attribute::base() const { return base_; }

sanguis::weapon_attribute_extra sanguis::weapon_attribute::extra() const { return extra_; }
