#ifndef SANGUIS_MESSAGES_PLAYER_DROP_OR_PICKUP_WEAPON_FWD_HPP_INCLUDED
#define SANGUIS_MESSAGES_PLAYER_DROP_OR_PICKUP_WEAPON_FWD_HPP_INCLUDED
	...
	majutsu::composite<
		boost::mpl::vector2<
			sanguis::messages::bind_player_message<
				sanguis::messages::types::message::player_drop_or_pickup_weapon
			>,
			majutsu::role<
