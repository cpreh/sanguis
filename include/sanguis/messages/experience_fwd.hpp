#ifndef SANGUIS_MESSAGES_EXPERIENCE_FWD_HPP_INCLUDED
#define SANGUIS_MESSAGES_EXPERIENCE_FWD_HPP_INCLUDED

#include <sanguis/messages/bind_entity_message_fwd.hpp>
#include <sanguis/messages/exp_fwd.hpp>
	...
	majutsu::composite<
		boost::mpl::vector2<
			sanguis::messages::bind_entity_message<
				sanguis::messages::types::message::experience
			>,
			majutsu::role<
				sanguis::messages::exp,
