#ifndef SANGUIS_MESSAGES_WEAPON_STATUS_FWD_HPP_INCLUDED
#define SANGUIS_MESSAGES_WEAPON_STATUS_FWD_HPP_INCLUDED
	...
	majutsu::composite<
		boost::mpl::vector2<
			sanguis::messages::bind_entity_message<
				sanguis::messages::types::message::weapon_status
			>,
			majutsu::role<
