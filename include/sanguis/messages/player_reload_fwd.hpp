#ifndef SANGUIS_MESSAGES_PLAYER_RELOAD_FWD_HPP_INCLUDED
#define SANGUIS_MESSAGES_PLAYER_RELOAD_FWD_HPP_INCLUDED
	...
	majutsu::composite<
		boost::mpl::vector2<
			sanguis::messages::bind_player_message<
				sanguis::messages::types::message::player_reload
			>,
			majutsu::role<
