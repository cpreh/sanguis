...
class attack_health : public sanguis::server::ai::behavior::attack
{
  FCPPT_NONMOVABLE(attack_health);
...
public:
  ...
  ~attack_health() override;

private:
  [[nodiscard]] sanguis::server::ai::speed_factor speed_factor() const override;
