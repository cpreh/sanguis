...
class spawn : public virtual sanguis::server::entities::ifaces::with_angle,
...
public:
  virtual void unregister(sanguis::server::entities::base & // NOLINT(google-runtime-references)
