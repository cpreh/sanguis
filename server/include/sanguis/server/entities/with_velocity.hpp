...
class with_velocity : public virtual sanguis::server::entities::ifaces::with_id,
...
public:
  ~with_velocity() override;

  [[nodiscard]] sanguis::server::entities::property::changeable &movement_speed() override;

  [[nodiscard]] sanguis::server::entities::movement_speed max_movement_speed() const;

  [[nodiscard]] sanguis::server::direction direction() const;

  [[nodiscard]] sanguis::server::speed speed() const override;

  void direction(sanguis::server::direction) override;
