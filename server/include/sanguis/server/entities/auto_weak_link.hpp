...
class auto_weak_link : public sanguis::server::entities::auto_weak_hook
{
public:
  using optional_with_links_ref = fcppt::optional::reference<sanguis::server::entities::with_links>;
  ...
  [[nodiscard]] bool operator==(sanguis::server::entities::auto_weak_link const &) const;

private:
  [[nodiscard]] sanguis::server::entities::with_links &checked_ref() const;
