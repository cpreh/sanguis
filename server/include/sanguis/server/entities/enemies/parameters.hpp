...
public:
  ...
  [[nodiscard]] sanguis::server::health health() const;

  [[nodiscard]] sanguis::server::regeneration regeneration() const;

  [[nodiscard]] sanguis::server::entities::movement_speed movement_speed() const;

  [[nodiscard]] sanguis::server::ai::create_function const &ai_create_function() const;

  [[nodiscard]] sanguis::server::weapons::unique_ptr &weapon();

  [[nodiscard]] sanguis::server::pickup_probability pickup_probability() const;
  ...
  [[nodiscard]] sanguis::server::auras::container &auras();

  [[nodiscard]] sanguis::server::weapons::ias ias() const;

  [[nodiscard]] sanguis::server::weapons::irs irs() const;

  sanguis::server::entities::enemies::parameters &health(sanguis::server::health);

  sanguis::server::entities::enemies::parameters &regeneration(sanguis::server::regeneration);

  sanguis::server::entities::enemies::parameters &
      movement_speed(sanguis::server::entities::movement_speed);

  sanguis::server::entities::enemies::parameters &
      pickup_probability(sanguis::server::pickup_probability);

  sanguis::server::entities::enemies::parameters &exp(sanguis::server::exp);

  sanguis::server::entities::enemies::parameters &
      difficulty(sanguis::server::entities::enemies::difficulty);

  sanguis::server::entities::enemies::parameters &ias(sanguis::server::weapons::ias);

  sanguis::server::entities::enemies::parameters &irs(sanguis::server::weapons::irs);

  sanguis::server::entities::enemies::parameters &add_aura(sanguis::server::auras::unique_ptr &&);

  sanguis::server::entities::enemies::parameters &
      armor_element(sanguis::server::damage::type, sanguis::server::damage::armor_unit);

  sanguis::server::entities::enemies::parameters &ai(sanguis::server::ai::create_function const &);
