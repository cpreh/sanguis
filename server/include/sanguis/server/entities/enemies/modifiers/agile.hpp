#ifndef SANGUIS_SERVER_ENTITIES_ENEMIES_MODIFIERS_AGILE_HPP_INCLUDED
#define SANGUIS_SERVER_ENTITIES_ENEMIES_MODIFIERS_AGILE_HPP_INCLUDED
...
sanguis::server::entities::enemies::attribute agile(
