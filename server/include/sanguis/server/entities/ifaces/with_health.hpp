...
public:
  ...
  [[nodiscard]] virtual sanguis::server::entities::property::changeable &health() = 0;

  [[nodiscard]] virtual sanguis::server::health current_health() const = 0;

  [[nodiscard]] virtual sanguis::server::health max_health() const = 0;
