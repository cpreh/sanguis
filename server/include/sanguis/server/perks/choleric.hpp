...
class choleric : public sanguis::server::perks::perk
{
  FCPPT_NONMOVABLE(choleric);

public:
  choleric(sanguis::diff_clock_cref, sanguis::random_generator_ref);
...
private:
  ...
  sanguis::random_variate<distribution> rand_;
};
