...
void sanguis::server::perks::tree::status::choose()
{
  if (level_.get() == max_level_.get())
  {
    return;
  }
...
sanguis::server::perks::tree::max_level sanguis::server::perks::tree::status::max_level() const
{
  return max_level_;
}

sanguis::server::level sanguis::server::perks::tree::status::level() const { return level_; }

sanguis::perk_type sanguis::server::perks::tree::status::type() const { return type_; }
