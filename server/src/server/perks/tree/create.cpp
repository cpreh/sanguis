...
sanguis::server::perks::tree::container sanguis::server::perks::tree::create()
{
  return fcppt::container::make<sanguis::server::perks::tree::container>(
      sanguis::server::perks::tree::object(sanguis::server::perks::tree::status(
          sanguis::perk_type::choleric,
          sanguis::server::perks::tree::required_player_level(2U),
          sanguis::server::perks::tree::required_parent_level(0U),
      ...
      sanguis::server::perks::tree::object(sanguis::server::perks::tree::status(
          ...
          sanguis::server::perks::tree::required_player_level(0U),
          sanguis::server::perks::tree::required_parent_level(0U),
          sanguis::server::perks::tree::max_level(
