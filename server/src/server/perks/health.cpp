...
sanguis::server::perks::health::health() : sanguis::server::perks::perk(sanguis::perk_type::health)
{
}

sanguis::server::perks::health::~health() = default;

void sanguis::server::perks::health::change(
