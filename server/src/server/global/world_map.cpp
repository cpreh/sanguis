...
sanguis::server::global::world_map::world_map(
    ...
    : worlds_(std::move(_worlds)), connections_(std::move(_connections))
{
}

sanguis::server::global::world_map::world_map(world_map &&) noexcept = default;

sanguis::server::global::world_map &
sanguis::server::global::world_map::operator=(world_map &&) noexcept = default;

sanguis::server::global::world_map::~world_map() = default;

sanguis::server::world::map const &sanguis::server::global::world_map::worlds() const
{
  return worlds_;
}
