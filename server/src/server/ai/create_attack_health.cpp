...
sanguis::server::ai::create_function sanguis::server::ai::create_attack_health(
    ...
    sanguis::server::ai::sight_range const _sight_range)
{
  return sanguis::server::ai::create_function{
      ...
      {
        auto const speed_factor(fcppt::literal<sanguis::server::ai::speed_factor>(
            ...
            fcppt::make_unique_ptr<sanguis::server::ai::tree::priority_sequence>(
                fcppt::container::make<sanguis::server::ai::tree::container>(
                    sanguis::server::ai::tree::make_leaf<
                        ...
                        _context, _sight_range, speed_factor),
                    sanguis::server::ai::tree::make_leaf<sanguis::server::ai::behavior::wander>(
                        _context, _random_generator, speed_factor))));
      }};
}
