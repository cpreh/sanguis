...
sanguis::server::ai::tree::basic_sequence::basic_sequence(
    ...
    : sanguis::server::ai::tree::base(), children_(std::move(_children))
{
}

sanguis::server::ai::tree::basic_sequence::~basic_sequence() = default;

sanguis::server::entities::transfer_result sanguis::server::ai::tree::basic_sequence::transfer()
{
  return fcppt::algorithm::fold(
      ...
      [](sanguis::server::ai::tree::base_unique_ptr const &_child,
        ...
        return sanguis::server::entities::combine_transfer(_child->transfer(), std::move(_state));
      });
}

sanguis::server::ai::tree::container &sanguis::server::ai::tree::basic_sequence::get()
{
  return children_;
}
