...
bool sanguis::server::ai::go_close_to_target(
    ...
    sanguis::server::ai::speed_factor const _speed_factor)
{
  return sanguis::server::ai::go_to_target(
      ...
      sanguis::server::ai::in_range{
          sanguis::server::collision::distance_entity_pos(_context.me(), _target.get().get()) <
          fcppt::literal<sanguis::server::space_unit>(100)},
      sanguis::server::ai::is_visible{sanguis::creator::tile_is_visible(
          _context.grid(),
          sanguis::server::world::center_to_grid_pos(_context.me().center()),
