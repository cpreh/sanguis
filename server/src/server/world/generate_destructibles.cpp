    ...
    sanguis::server::world::difficulty const _difficulty)
{
  return sanguis::server::world::place_multiple(
      ...
      sanguis::server::world::place_with_id_callback(
          [_destructible, &_load_context, _difficulty]
          {
            return sanguis::server::world::make_destructible(
                _destructible.type(), _load_context, _difficulty);
          }),
      _destructible.pos().get(),
      _load_context.model_size(sanguis::load::model::destructible_path(_destructible.type())));
}
