...
fcppt::log::context &sanguis::server::world::parameters::log_context() const
{
  return log_context_.get();
}

sanguis::random_generator &sanguis::server::world::parameters::random_generator() const
{
...
sanguis::server::world::context &sanguis::server::world::parameters::context() const
{
  return context_.get();
}

sanguis::server::environment::load_context &sanguis::server::world::parameters::load_context() const
{
