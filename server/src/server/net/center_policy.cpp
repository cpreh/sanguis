...
sanguis::duration sanguis::server::net::center_policy::start_duration()
{
...
sanguis::duration sanguis::server::net::center_policy::difference(
    sanguis::server::center const &_center1, sanguis::server::center const &_center2)
{
  return sanguis::duration_second(
