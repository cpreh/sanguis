...
{
  return spread_radius_;
}

sanguis::server::weapons::shells sanguis::server::weapons::shotgun_parameters::shells() const
{
  return shells_;
}
...
sanguis::server::weapons::range sanguis::server::weapons::shotgun_parameters::range() const
{
  return range_;
}

void sanguis::server::weapons::shotgun_parameters::extra_accuracy(
    sanguis::server::weapons::accuracy const _accuracy)
{
  accuracy_.extra(_accuracy);
}

void sanguis::server::weapons::shotgun_parameters::extra_spread_radius(
    sanguis::server::weapons::spread_radius const _spread_radius)
{
  spread_radius_.extra(_spread_radius);
}

void sanguis::server::weapons::shotgun_parameters::extra_damage(
    sanguis::server::weapons::damage const _damage)
{
  damage_.extra(_damage);
}

void sanguis::server::weapons::shotgun_parameters::extra_magazine_size(
    sanguis::server::weapons::magazine_size const _magazine_size)
{
