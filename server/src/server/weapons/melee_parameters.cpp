...
sanguis::server::weapons::range sanguis::server::weapons::melee_parameters::range() const
{
  return range_;
}
...
{
  return damage_values_;
}

void sanguis::server::weapons::melee_parameters::extra_damage(
    sanguis::server::weapons::damage const _damage)
{
