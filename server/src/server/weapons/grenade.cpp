...
sanguis::server::weapons::grenade::~grenade() = default;
...
sanguis::server::weapons::unique_ptr sanguis::server::weapons::grenade::clone() const
{
  return fcppt::unique_ptr_to_base<sanguis::server::weapons::weapon>(
      fcppt::make_unique_ptr<sanguis::server::weapons::grenade>(this->parameters(), damage_, aoe_));
}

sanguis::server::weapons::attack_result
sanguis::server::weapons::grenade::do_attack(sanguis::server::weapons::attack const &_attack)
{
  return sanguis::server::weapons::insert_to_attack_result(_attack.environment().insert(
      fcppt::unique_ptr_to_base<sanguis::server::entities::with_id>(
          fcppt::make_unique_ptr<sanguis::server::entities::projectiles::grenade>(
...
sanguis::weapon_attribute_vector sanguis::server::weapons::grenade::attributes() const
{
