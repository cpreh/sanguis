...
sanguis::server::weapons::spider_parameters::cast_point() const
{
	return
		cast_point_;
}
...
sanguis::server::weapons::spider_parameters::range() const
{
	return
		range_;
}
...
void
sanguis::server::weapons::spider_parameters::extra_health(
	sanguis::server::health const _health
)
{
	health_.extra(
