...
sanguis::server::weapons::monster_spawner::~monster_spawner() = default;

sanguis::server::weapons::monster_spawner::monster_spawner(
    sanguis::server::weapons::parameters const &_parameters)
    : sanguis::server::weapons::weapon{_parameters},
      common_parameters_{_parameters.common_parameters()}
{
}

sanguis::server::weapons::unique_ptr sanguis::server::weapons::monster_spawner::clone() const
{
  return fcppt::unique_ptr_to_base<sanguis::server::weapons::weapon>(
      fcppt::make_unique_ptr<sanguis::server::weapons::monster_spawner>(this->parameters()));
}

sanguis::server::weapons::attack_result sanguis::server::weapons::monster_spawner::do_attack(
    sanguis::server::weapons::attack const &_attack)
{
  return sanguis::server::weapons::insert_to_attack_result(_attack.environment().insert(
      sanguis::server::entities::enemies::create(
          ...
          fcppt::random::distribution::make_basic(
              fcppt::random::distribution::parameters::make_uniform_enum<
                  sanguis::creator::enemy_type>())(this->random_generator()),
          ...
          sanguis::server::entities::enemies::special_chance(1.F)),
      sanguis::server::entities::insert_parameters(
          sanguis::server::center(_attack.target().get()), _attack.angle())));
}

sanguis::weapon_attribute_vector sanguis::server::weapons::monster_spawner::attributes() const
{
