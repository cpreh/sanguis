...
sanguis::server::weapons::melee::melee(
    ...
    : sanguis::server::weapons::weapon(sanguis::server::weapons::parameters{
          _common_parameters,
          sanguis::weapon_type(sanguis::primary_weapon_type::melee),
      ...
      damage_values_(_parameters.damage_values())
{
}

sanguis::server::weapons::melee::~melee() = default;
...
sanguis::server::weapons::unique_ptr sanguis::server::weapons::melee::clone() const
{
  return fcppt::unique_ptr_to_base<sanguis::server::weapons::weapon>(
      fcppt::make_unique_ptr<sanguis::server::weapons::melee>(
          this->parameters(), damage_, damage_values_));
}

sanguis::server::weapons::attack_result
sanguis::server::weapons::melee::do_attack(sanguis::server::weapons::attack const &_attack)
{
  sanguis::server::environment::insert_no_result(
      _attack.environment(),
      fcppt::unique_ptr_to_base<sanguis::server::entities::simple>(
          fcppt::make_unique_ptr<sanguis::server::entities::projectiles::melee>(
              this->owner().team(),
              damage_.value(),
              sanguis::server::entities::modify_damages(this->owner(), damage_values_))),
...
sanguis::weapon_attribute_vector sanguis::server::weapons::melee::attributes() const
{
