...
sanguis::server::entities::with_ai::with_ai(
    ...
    : sanguis::server::entities::with_auras_id(std::move(_auras)),
      sanguis::server::entities::with_weapon(
          sanguis::server::weapons::optional_unique_ptr(std::move(_start_weapon)), _ias, _irs),
      update_timer_(
          sanguis::diff_timer::parameters(
              fcppt::make_cref(this->diff_clock()), sanguis::server::ai::update_interval())
              .expired(true)),
      create_ai_{std::move(_create_ai)},
      ai_context_(fcppt::make_ref(*this)),
      ai_()
{
}
...
sanguis::server::entities::transfer_result sanguis::server::entities::with_ai::on_create()
{
  // TODO(philipp): Improve this!
  sanguis::server::ai::tree::base_unique_ptr new_ai(create_ai_(fcppt::make_ref(ai_context_)));

  sanguis::server::ai::tree::base &ai_ref(*new_ai);

  ai_ = optional_ai_unique_ptr(std::move(new_ai));
