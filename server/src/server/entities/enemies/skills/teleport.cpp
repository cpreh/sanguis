...
sanguis::server::entities::enemies::skills::teleport::~teleport() = default;

void sanguis::server::entities::enemies::skills::teleport::update(
    sanguis::server::entities::enemies::enemy &_entity)
{
  ...
  fcppt::optional::maybe_void(
      _entity.target(),
      [&_entity](sanguis::server::weapons::target const &_target)
      { _entity.center(sanguis::server::center(_target.get())); });
}

sanguis::server::entities::enemies::attribute
sanguis::server::entities::enemies::skills::teleport::attribute() const
{
  return sanguis::server::entities::enemies::attribute(FCPPT_TEXT("teleporting"));
}
