...
sanguis::server::entities::enemies::skills::skill::skill() = default;

sanguis::server::entities::enemies::skills::skill::~skill() = default;

void sanguis::server::entities::enemies::skills::skill::update(
    sanguis::server::entities::enemies::enemy &)
{
}

void sanguis::server::entities::enemies::skills::skill::on_die(
