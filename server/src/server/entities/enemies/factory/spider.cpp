...
sanguis::server::entities::with_id_unique_ptr sanguis::server::entities::enemies::factory::spider(
    sanguis::server::entities::enemies::factory::parameters const &_parameters)
{
  return sanguis::server::entities::enemies::factory::make(
      ...
      sanguis::server::health(
          8.F // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
