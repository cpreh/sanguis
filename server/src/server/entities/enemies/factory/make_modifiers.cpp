...
{
  return sanguis::server::random::draw<sanguis::server::entities::enemies::modifiers::container>(
      _random_generator,
      ...
      sanguis::server::random::create_function<
          ...
          sanguis::server::entities::enemies::modifiers::callback>(
          fcppt::function<sanguis::server::entities::enemies::modifiers::callback(
      ...
      sanguis::server::random::less_function<
          ...
          fcppt::function<bool(
              ...
              { return std::less<>()(_callback1, _callback2); }}),
