...
{
  return linear_decrease_;
}

void sanguis::server::entities::property::base::constant(
...
void sanguis::server::entities::property::base::linear(
...
void sanguis::server::entities::property::base::linear_decrease(
    sanguis::server::entities::property::linear_decrease const &_linear_decrease)
{
  linear_decrease_ = _linear_decrease;
...
sanguis::server::entities::property::base::base(base &&) noexcept = default;
...
void sanguis::server::entities::property::base::recalc_max()
{
  this->on_recalc_max(
      std::max(
          ((base_ + constant_.value()) * linear_.value()),
          fcppt::literal<sanguis::server::entities::property::value>(0)) *
