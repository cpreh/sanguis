...
sanguis::server::entities::friend_::friend_(
    ...
    : sanguis::server::entities::ifaces::with_team(),
      ...
      sanguis::server::entities::with_velocity(
          _load_context.model_size(sanguis::load::model::friend_path(_friend_type)),
          sanguis::server::optional_mass(),
          sanguis::server::entities::movement_speed_initial(
              sanguis::server::entities::property::initial_zero(_movement_speed.get())),
          sanguis::server::direction(0.F)),
      friend_type_(_friend_type)
{
}

sanguis::server::entities::friend_::~friend_() = default;

sanguis::server::entities::optional_transfer_result sanguis::server::entities::friend_::on_transfer(
    sanguis::server::entities::transfer_parameters const &_parameters)
{
  if (sanguis::server::collision::with_world(
          _parameters.center(), this->radius(), _parameters.grid()))
  {
    return sanguis::server::entities::optional_transfer_result();
  }

  sanguis::server::entities::with_auras::on_transfer(_parameters);

  return sanguis::server::entities::with_velocity::on_transfer(_parameters);
}

void sanguis::server::entities::friend_::update()
{
...
sanguis::server::team sanguis::server::entities::friend_::team() const
{
  return sanguis::server::team::players;
}

sanguis::messages::server::unique_ptr sanguis::server::entities::friend_::add_message(
    sanguis::server::player_id const, sanguis::collision::world::created const _created) const
{
  return sanguis::messages::server::create_ptr(
      alda::message::init_record<sanguis::messages::server::add_friend>(
          ...
          sanguis::messages::roles::friend_type{} = friend_type_));
}

sanguis::collision::world::body_group sanguis::server::entities::friend_::collision_group() const
{
