    ...
    : sanguis::server::entities::projectiles::projectile(
      ...
      angle_rng_(
          ...
          angle_distribution::param_type(
              angle_distribution::param_type::min(sanguis::server::angle(0.F)),
              angle_distribution::param_type::sup(
                  sanguis::server::angle(std::numbers::pi_v<sanguis::server::angle::value_type>) *
...
sanguis::server::entities::projectiles::scatter::~scatter() = default;

void sanguis::server::entities::projectiles::scatter::update()
{
  ...
  fcppt::optional::maybe_void(
      ...
      {
        sanguis::server::angle const random_angle(angle_rng_());

        sanguis::server::environment::insert_no_result(
            _environment.get(),
            create_(_environment.get(), this->team(), random_angle),
            sanguis::server::entities::insert_parameters(this->center(), random_angle));
      });
}

void sanguis::server::entities::projectiles::scatter::do_damage(
