...
template<>
sanguis::messages::auto_ptr
sanguis::server::message_convert<sanguis::messages::add_enemy>(
	entities::entity const &e)
{
	return messages::auto_ptr(
...
template<>
sanguis::messages::auto_ptr
sanguis::server::message_convert<sanguis::messages::add_pickup>(
	entities::entity const &e)
{
	return messages::auto_ptr(
...
template<>
sanguis::messages::auto_ptr
sanguis::server::message_convert<sanguis::messages::add_weapon_pickup>(
	entities::entity const &e)
{
	return messages::auto_ptr(
