...
sanguis::tools::libmergeimage::aux_::merge_paths(
	sanguis::tools::libmergeimage::aux_::path_vector_vector const &_elements,
	sanguis::tools::libmergeimage::aux_::count_maximum const _maximum
)
{
	...
	sanguis::tools::libmergeimage::aux_::path_vector accum;

	auto const cost(
		[](
			sanguis::tools::libmergeimage::aux_::path_vector const &_vector
		)
		{
			return
				_vector.size();
	...
	for(
		sanguis::tools::libmergeimage::aux_::path_vector const &element
		:
		_elements
	)
	{
