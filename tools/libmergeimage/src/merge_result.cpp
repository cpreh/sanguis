...
sanguis::tools::libmergeimage::merge_result::merge_result(
    ...
    : cell_size_(_cell_size), images_(std::move(_images))
{
}

sanguis::tools::libmergeimage::merge_result::merge_result(merge_result &&) noexcept = default;

sanguis::tools::libmergeimage::merge_result &
sanguis::tools::libmergeimage::merge_result::operator=(merge_result &&) noexcept = default;

sanguis::tools::libmergeimage::merge_result::~merge_result() = default;

sanguis::model::cell_size sanguis::tools::libmergeimage::merge_result::cell_size() const
{
  return cell_size_;
}
