#ifndef SANGUIS_CREATOR_AUX_RANDGEN_HPP_INCLUDED
#define SANGUIS_CREATOR_AUX_RANDGEN_HPP_INCLUDED

#include <sanguis/creator/seed.hpp>
#include <sanguis/creator/aux/rand_value.hpp>
...
public:
	...
	typedef sanguis::creator::aux::rand_value result_type;
