...
sanguis::creator::impl::optional_pos find_closest(
    fcppt::container::grid::object<Value, 2U> const &_grid,
    sanguis::creator::pos const &_pos,
    Attribute const _attribute,
    fcppt::optional::object<sanguis::creator::pos::value_type> _max_radius)
{
  ...
  auto const max_radius = fcppt::optional::from(
      _max_radius,
      [w, h, x0, y0]
      {
        return
  ...
  while (radius <= max_radius)
  {
    ...
    if (!fcppt::container::grid::in_range(_grid, pos))
    {
      continue;
    }
  ...
  return sanguis::creator::impl::optional_pos();
}
