...
sanguis::creator::impl::parameters::parameters(
    ...
    fcppt::reference<sanguis::creator::impl::random::generator> const _randgen,
...
fcppt::log::object &sanguis::creator::impl::parameters::log() const { return log_.get(); }

sanguis::creator::impl::random::generator &sanguis::creator::impl::parameters::randgen() const
{
  return randgen_.get();
}

sanguis::creator::spawn_boss sanguis::creator::impl::parameters::spawn_boss() const
{
  return spawn_boss_;
}
