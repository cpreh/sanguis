...
sanguis::creator::impl::generators::maze(sanguis::creator::impl::parameters const &_parameters)
{
  constexpr sanguis::creator::size_type const side_length{15U};

  sanguis::creator::impl::reachable_grid initial_maze{
      sanguis::creator::impl::reachable_grid::dim(side_length, side_length),
  ...
  sanguis::creator::destructible_container destructibles{
      sanguis::creator::impl::place_destructibles(fcppt::make_ref(grid), _parameters.randgen())};

  sanguis::creator::background_grid grid_bg(
      grid.size(), sanguis::creator::background_tile::asphalt);
