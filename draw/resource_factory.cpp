...
sge::virtual_texture_ptr environment::load_texture(const sanguis::draw::resource::identifier_type& id)
{
...
load_texture(const sanguis::draw::resource::identifier_type&);
...
const sge::virtual_texture_ptr
sanguis::draw::resource::texture(const identifier_type& id)
{
	return map_get_or_create(textures, id, load_texture);
}

sanguis::draw::resource::connection::connection(const sge::image_loader_ptr pm,const sge::renderer_ptr rend) 
{
	if (env)
...
sanguis::draw::resource::connection::~connection() 
{ 
	if (!env)
...
const sge::virtual_texture_ptr
load_texture(const sanguis::draw::resource::identifier_type& id)
{
	check_env();
