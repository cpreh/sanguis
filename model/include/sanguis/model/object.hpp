...
public:
  ...
  [[nodiscard]] SANGUIS_MODEL_SYMBOL sanguis::model::part &part(sanguis::model::part_name const &);

  [[nodiscard]] SANGUIS_MODEL_SYMBOL sanguis::model::part const &
  part(sanguis::model::part_name const &) const;

  [[nodiscard]] SANGUIS_MODEL_SYMBOL sanguis::model::part &
  operator[](sanguis::model::part_name const &);

  [[nodiscard]] SANGUIS_MODEL_SYMBOL sanguis::model::part_map &parts();

  [[nodiscard]] SANGUIS_MODEL_SYMBOL sanguis::model::part_map const &parts() const;

  [[nodiscard]] SANGUIS_MODEL_SYMBOL sanguis::model::cell_size cell_size() const;
