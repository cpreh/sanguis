...
sanguis::model::impl::deserialize::weapon_category(sge::parse::json::object const &_object)
{
  return sanguis::model::weapon_category(
      sanguis::model::impl::deserialize::animation_map(_object),
