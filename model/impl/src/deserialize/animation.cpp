...
sanguis::model::impl::deserialize::animation(sge::parse::json::object const &_object)
{
  return sanguis::model::animation(
      sanguis::model::impl::deserialize::animation_range(_object),
      sanguis::model::impl::deserialize::animation_delay(_object),
      sanguis::model::impl::deserialize::animation_sound(_object),
      sanguis::model::impl::deserialize::image_name(_object));
}
