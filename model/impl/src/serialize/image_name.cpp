...
sanguis::model::impl::serialize::image_name(sanguis::model::optional_image_name const &_opt_name)
{
  return fcppt::optional::map(
      ...
      [](sanguis::model::image_name const &_name)
      {
        return sge::parse::json::member{
            sge::charconv::utf8_string{"texture"},
            sge::parse::json::make_value(sge::charconv::fcppt_string_to_utf8(_name.get()))};
      });
}
