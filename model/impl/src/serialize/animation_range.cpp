...
sanguis::model::impl::serialize::animation_range(sanguis::model::animation_range const &_range)
{
  return sge::parse::json::member(
      "range",
      sge::parse::json::make_value(sge::parse::json::convert::from_container(fcppt::math::to_array(
          sanguis::model::impl::animation_range_vector{_range.begin(), _range.end()}))));
}
