...
fcppt::optional::object<sge::parse::json::member> sanguis::model::impl::serialize::animation_sound(
  ...
  return fcppt::optional::map(
      ...
      [](sanguis::model::animation_sound const &_sound)
      {
        return sge::parse::json::member{
            sge::charconv::utf8_string{"sound"},
            sge::parse::json::make_value(sge::charconv::fcppt_string_to_utf8(_sound.get()))};
      });
}
