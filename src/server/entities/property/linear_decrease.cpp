...
sanguis::server::entities::property::linear_decrease::linear_decrease()
:
	value_(
		1
	)
...
void
sanguis::server::entities::property::linear_decrease::mul(
...
void
sanguis::server::entities::property::linear_decrease::div(
