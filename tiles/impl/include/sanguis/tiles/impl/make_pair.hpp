...
sanguis::creator::enable_if_tile<Tile, sanguis::tiles::impl::optional_pair<Tile>>
    make_pair(sanguis::tiles::impl::neighbors<Tile>);

}

#define SANGUIS_TILES_DECLARE_MAKE_PAIR(tile_type) \
...
SANGUIS_CREATOR_INSTANTIATE_TILE(SANGUIS_TILES_DECLARE_MAKE_PAIR);
