...
sanguis::tiles::cell_container draw_connecting(
    ...
    sanguis::creator::sup const _sup)
{
  return sanguis::tiles::impl::draw_base(
      ...
      _min,
      _sup,
      sanguis::tiles::impl::shift(-fcppt::math::vector::fill<sanguis::tiles::pos>(
          fcppt::cast::size<sanguis::tiles::unit>(
              fcppt::cast::to_signed(sanguis::creator::tile_size::value)) /
          fcppt::literal<sanguis::tiles::unit>(2))),
      sanguis::tiles::impl::get_content_function{[&_log, _collection, _error_code, &_grid](
                                                     sanguis::creator::pos const _pos) {
        return sanguis::tiles::impl::connecting_images(_log, _collection, _error_code, _grid, _pos);
      }});
}
