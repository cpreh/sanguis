...
{
  return fcppt::algorithm::map<sanguis::tiles::area_container>(
      sge::parse::json::get_exn<sge::parse::json::array const>(fcppt::make_cref(_value))
          .get()
          .elements,
      [_size](fcppt::recursive<sge::parse::json::value> const &_element)
      {
        return fcppt::math::box::structure_cast<sge::image2d::rect, fcppt::cast::size_fun>(
            ...
            sanguis::model::cell_area_from_index(
                sanguis::model::image_size(
                    fcppt::math::dim::structure_cast<sanguis::model::dim, fcppt::cast::size_fun>(
                        _size)),
                sanguis::model::cell_size(fcppt::math::dim::fill<sanguis::model::dim>(
                    // TODO(philipp): Read this from the json file
                    96UL // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
                    )),
                fcppt::cast::size<sanguis::model::animation_index>(
                    fcppt::cast::to_unsigned(sge::parse::json::get_exn<sge::parse::json::int_type>(
