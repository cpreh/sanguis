...
{
  return fcppt::options::make_base<sanguis::client::args::result>(fcppt::options::apply(
      sanguis::server::args::create_parser(),
      fcppt::options::make_optional(
          fcppt::options::
              option<sanguis::client::args::labels::display_width, sge::renderer::screen_unit>{
                  fcppt::options::optional_short_name{},
                  fcppt::options::long_name{FCPPT_TEXT("display-width")},
                  fcppt::options::no_default_value<sge::renderer::screen_unit>(),
                  fcppt::options::optional_help_text{
                      fcppt::options::help_text{FCPPT_TEXT("The width of the display mode")}}}),
      fcppt::options::make_optional(
          fcppt::options::
              option<sanguis::client::args::labels::display_height, sge::renderer::screen_unit>{
                  fcppt::options::optional_short_name{},
                  fcppt::options::long_name{FCPPT_TEXT("display-height")},
                  fcppt::options::no_default_value<sge::renderer::screen_unit>(),
                  fcppt::options::optional_help_text{
                      fcppt::options::help_text{FCPPT_TEXT("The height of the display mode")}}}),
      fcppt::options::option<sanguis::client::args::labels::log_level, fcppt::log::level>{
          fcppt::options::optional_short_name{},
          fcppt::options::long_name{FCPPT_TEXT("client-log-level")},
          fcppt::options::make_default_value(fcppt::optional::make(fcppt::log::level::info)),
          fcppt::options::optional_help_text{
              fcppt::options::help_text{FCPPT_TEXT("The log level used by the client")}}},
      fcppt::options::option<sanguis::client::args::labels::sge_log_level, fcppt::log::level>{
          fcppt::options::optional_short_name{},
          fcppt::options::long_name{FCPPT_TEXT("sge-log-level")},
          fcppt::options::make_default_value(fcppt::optional::make(fcppt::log::level::warning)),
          fcppt::options::optional_help_text{
              fcppt::options::help_text{FCPPT_TEXT("The log level used by sge")}}},
      fcppt::options::option<
          sanguis::client::args::labels::history_size,
          sge::console::gfx::output_line_limit>{
          fcppt::options::optional_short_name{},
          fcppt::options::long_name{FCPPT_TEXT("console-history-size")},
          fcppt::options::make_default_value(
              fcppt::optional::make(sge::console::gfx::output_line_limit{
                  1000U // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
              })),
          fcppt::options::optional_help_text{
              fcppt::options::help_text{FCPPT_TEXT("The number of history lines in the console")}}},
      fcppt::options::make_optional(fcppt::options::option<
                                    sanguis::client::args::labels::multi_samples,
                                    sge::renderer::pixel_format::multi_samples>{
          fcppt::options::optional_short_name{},
          fcppt::options::long_name{FCPPT_TEXT("multi-samples")},
          fcppt::options::no_default_value<sge::renderer::pixel_format::multi_samples>(),
          fcppt::options::optional_help_text{
              fcppt::options::help_text{FCPPT_TEXT("The number of multi samples")}}}),
      fcppt::options::flag<sanguis::client::args::labels::draw_debug, sanguis::client::draw::debug>{
          fcppt::options::optional_short_name{},
          fcppt::options::long_name{FCPPT_TEXT("draw-debug")},
          fcppt::options::make_active_value(sanguis::client::draw::debug{true}),
          fcppt::options::make_inactive_value(sanguis::client::draw::debug{false}),
          fcppt::options::optional_help_text{
              fcppt::options::help_text{FCPPT_TEXT("Whether to draw debug tiles")}}}));
}
