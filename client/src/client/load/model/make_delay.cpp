...
sanguis::duration sanguis::client::load::model::make_delay(
    sanguis::model::animation const &_animation,
    sanguis::model::optional_animation_delay const &_header_delay)
{
  return std::chrono::duration_cast<sanguis::duration>(
      fcppt::optional::to_exception(
          _animation.animation_delay().has_value() ? _animation.animation_delay() : _header_delay,
          []
          {
