...
std::filesystem::path const &sanguis::client::load::model::global_parameters::path() const
{
  return path_;
}
...
sanguis::model::cell_size const &sanguis::client::load::model::global_parameters::cell_size() const
{
  return cell_size_;
}
...
sanguis::client::load::model::global_parameters::new_image(
    sanguis::model::optional_image_name &&_image) const
{
  return _image.has_value() ? sanguis::client::load::model::global_parameters(
                                  fcppt::copy(this->path()),
                                  fcppt::make_cref(this->textures()),
                                  fcppt::make_cref(this->sounds()),
                                  this->cell_size(),
                                  this->delay(),
                                  std::move(_image))
                            : *this;
