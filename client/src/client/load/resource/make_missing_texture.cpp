...
sge::texture::const_part_unique_ptr sanguis::client::load::resource::make_missing_texture(
    sge::renderer::device::core_ref const _renderer,
    sge::image::size_type const _size,
    sge::image::color::any::object const &_color1,
    sge::image::color::any::object const &_color2)
{
  sge::image2d::dim const dim{fcppt::math::dim::fill<sge::image2d::dim>(_size)};
  ...
  store_type const store{
      ...
      store_type::init_function{
          [dim, &_color1, &_color2](sge::image2d::store::rgba8::view_type const &_view)
          {
  ...
  return sanguis::client::load::resource::texture_from_view(
      _renderer, sge::image2d::view::const_object(store.const_wrapped_view()));
}
