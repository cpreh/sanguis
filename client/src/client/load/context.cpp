...
sanguis::client::load::context::context(
    ...
    : resource_ctx_(_log_context, _renderer, _image_loader, _audio_loader, _audio_player),
      model_ctx_(_log_context, fcppt::make_cref(resource_ctx_))
{
}

sanguis::client::load::context::~context() = default;

sanguis::client::load::resource::context const &sanguis::client::load::context::resources() const
{
  return resource_ctx_;
}

sanguis::client::load::model::context const &sanguis::client::load::context::models() const
{
  return model_ctx_;
}
