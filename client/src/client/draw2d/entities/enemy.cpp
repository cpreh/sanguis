          ...
          sanguis::client::draw2d::entities::with_buffs_auras_model_parameters(
              ...
              sanguis::client::draw2d::entities::with_auras_model_parameters(
                  ...
                  sanguis::client::draw2d::entities::model::parameters(
                      _load_parameters,
                      sanguis::load::model::enemy_path(_enemy_type),
                      ...
                      sge::image::color::any::convert<
                          ...
                          sanguis::client::draw2d::entities::enemy_color(_enemy_kind)))))),
      enemy_type_{_enemy_type},
      name_{fcppt::copy(_name.get()), sanguis::client::draw2d::entities::enemy_color(_enemy_kind)}
{
}

sanguis::client::draw2d::entities::enemy::~enemy() = default;

void sanguis::client::draw2d::entities::enemy::on_create(
    sanguis::client::draw2d::entities::create_parameters const &_create_parameters)
{
  fcppt::optional::maybe_void(
      ...
      [&_create_parameters](sanguis::client::draw2d::entities::own_unique_ptr &&_spawn_particle)
      { _create_parameters.insert_own_callback()(std::move(_spawn_particle)); });
}
