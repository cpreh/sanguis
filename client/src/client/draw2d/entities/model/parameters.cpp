...
sanguis::client::draw2d::entities::model::parameters::parameters(
    ...
    : load_parameters_(_load_parameters),
      ...
      order_function_{std::move(_order_function)},
      health_pair_{_health_pair},
      decay_option_{_decay_option},
      primary_weapon_type_{_primary_weapon_type},
...
{
  return load_parameters_;
}

sanguis::load::model::path const &sanguis::client::draw2d::entities::model::parameters::path() const
{
  return path_;
}
...
{
  return decay_option_;
}

sanguis::optional_primary_weapon_type
sanguis::client::draw2d::entities::model::parameters::primary_weapon_type() const
{
  return primary_weapon_type_;
}

sanguis::weapon_status sanguis::client::draw2d::entities::model::parameters::weapon_status() const
{
  return weapon_status_;
}

sanguis::client::draw2d::speed sanguis::client::draw2d::entities::model::parameters::speed() const
{
  return speed_;
}
