...
sanguis::client::draw2d::sprite::rotation impl(
    ...
    sanguis::client::draw2d::sprite::rotation const _desired_orientation)
{
  ...
  auto const twopi(
      std::numbers::pi_v<sanguis::client::draw2d::funit> *
      fcppt::literal<sanguis::client::draw2d::funit>(2));

  // this is the "inner distance" from
  sanguis::client::draw2d::funit const abs_dist(
      std::abs(_desired_orientation.get() - _orientation.get()));

  sanguis::client::draw2d::funit const swap_dist(
      _orientation > _desired_orientation
          ? twopi - _orientation.get() + _desired_orientation.get()
          : twopi - _desired_orientation.get() + _orientation.get());

  sanguis::client::draw2d::funit const min_dist(std::min(swap_dist, abs_dist));

  sanguis::client::draw2d::funit const null(fcppt::literal<sanguis::client::draw2d::funit>(0));

  sanguis::client::draw2d::funit const one(fcppt::literal<sanguis::client::draw2d::funit>(1));
  ...
  sanguis::client::draw2d::funit const dir(
      _orientation > _desired_orientation ? (swap_dist > abs_dist ? minus_one : one)
                                          : (swap_dist > abs_dist ? one : minus_one));
  ...
  return dir > null
             ? (new_orientation < _desired_orientation ? new_orientation : _desired_orientation)
             : (new_orientation > _desired_orientation ? new_orientation : _desired_orientation);
}

}

sanguis::client::draw2d::sprite::rotation sanguis::client::draw2d::entities::model::orientation(
    sanguis::client::draw2d::funit const _delta,
    sanguis::client::draw2d::sprite::rotation const _orientation,
    sanguis::client::draw2d::entities::model::desired_orientation const _desired_orientation)
{
  return impl(
      _delta,
      sanguis::client::draw2d::entities::model::clamp_orientation(_orientation),
      sanguis::client::draw2d::entities::model::clamp_orientation(_desired_orientation.get()));
}
