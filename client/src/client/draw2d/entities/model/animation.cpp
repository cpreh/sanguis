...
sanguis::client::draw2d::entities::model::animation::animation(
    ...
    : texture_animation_(std::move(_texture_animation)),
      animation_type_(_animation_type),
      sound_(std::move(_sound))
{
}

sanguis::client::draw2d::entities::model::animation::animation(animation &&) noexcept = default;

sanguis::client::draw2d::entities::model::animation &
sanguis::client::draw2d::entities::model::animation::operator=(animation &&) noexcept = default;

sanguis::client::draw2d::entities::model::animation::~animation() = default;
...
sge::texture::const_part_ref sanguis::client::draw2d::entities::model::animation::current_texture()
{
  return texture_animation_.current_texture();
}
...
bool sanguis::client::draw2d::entities::model::animation::ended() const
{
  return texture_animation_.ended();
}
