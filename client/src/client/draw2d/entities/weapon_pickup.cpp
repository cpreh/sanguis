...
sanguis::client::draw2d::entities::weapon_pickup::weapon_pickup(
    ...
    : sanguis::client::draw2d::entities::model::object(
          sanguis::client::draw2d::entities::model::parameters(
              _load_parameters,
              sanguis::load::model::weapon_pickup_path(_weapon_description.weapon_type()),
      ...
      weapon_description_(_weapon_description)
{
}

sanguis::client::draw2d::entities::weapon_pickup::~weapon_pickup() = default;
  ...
  return sanguis::client::draw2d::entities::hover::optional_info(
      sanguis::client::draw2d::entities::hover::info(
          sanguis::client::draw2d::entities::hover::variant(
              sanguis::client::draw2d::entities::hover::weapon(weapon_description_))));
}
