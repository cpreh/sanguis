        ...
        [&_load_parameters, _center](sanguis::creator::background_tile const _tile)
        {
          ...
          case sanguis::creator::background_tile::dirt:
            return sanguis::client::draw2d::entities::optional_own_unique_ptr(
                fcppt::unique_ptr_to_base<sanguis::client::draw2d::entities::own>(
                    fcppt::make_unique_ptr<sanguis::client::draw2d::entities::particle>(
                        _load_parameters,
                        sanguis::client::draw2d::entities::particle_name{FCPPT_TEXT("dirt_pile")},
