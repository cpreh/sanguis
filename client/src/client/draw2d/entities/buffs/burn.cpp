...
sanguis::client::draw2d::entities::buffs::burn::burn(
    ...
    : sanguis::client::draw2d::entities::buffs::base(),
      animation_(
          fcppt::make_cref(
              _model_collection
                  .get()[sanguis::load::model::path{std::filesystem::path{FCPPT_TEXT("fire")}}]
                        [FCPPT_TEXT("default")][sanguis::optional_primary_weapon_type()]
      ...
      sprite_(
          sge::sprite::roles::connection{} =
              _normal_system->connection(sanguis::client::draw2d::z_ordering::flare),
          sge::sprite::roles::center{} = _model.center().get(),
          ...
          sge::sprite::roles::size_or_texture_size{} =
              sanguis::client::draw2d::sprite::size_or_texture_size{
                  (_model.master().size() /
                   fcppt::literal<sanguis::client::draw2d::sprite::unit>(2))
                      .get_unsafe()},
...
sanguis::client::draw2d::entities::buffs::burn::~burn() = default;

void sanguis::client::draw2d::entities::buffs::burn::update(
    sanguis::client::draw2d::entities::model::object const &_model)
{
  sprite_.center(_model.center().get());
