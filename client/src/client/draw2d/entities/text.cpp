...
sanguis::client::draw2d::entities::text::~text() = default;
...
sanguis::client::draw2d::entities::text::text(
    ...
    : sanguis::client::draw2d::entities::own(),
      life_time_(sanguis::diff_timer::parameters{_diff_clock, sanguis::duration_second(1.F)}),
      texture_(fcppt::unique_ptr_to_const(sge::font::draw::create_texture(
          fcppt::make_ref(_sprite_system->renderer()),
          *_text,
          sanguis::client::draw2d::font_color_format(),
          sge::renderer::texture::emulate_srgb::no))),
      sprite_(
          sge::sprite::roles::connection{} = _sprite_system->connection(_z_ordering),
          sge::sprite::roles::center{} =
              _center.get() - fcppt::math::vector::structure_cast<
                                  sanguis::client::draw2d::sprite::point,
                                  fcppt::cast::size_fun>(_text->rect().pos()),
          ...
          sge::sprite::roles::texture0{} = sge::texture::const_part_ref{*texture_}),
      origin_(sprite_.center())
{
}

void sanguis::client::draw2d::entities::text::update()
{
  sprite_.center(
      origin_.get() -
      sanguis::client::draw2d::sprite::point{
          fcppt::literal<sanguis::client::draw2d::sprite::unit>(0),
          fcppt::cast::float_to_int<sanguis::client::draw2d::sprite::unit>(
              sge::timer::elapsed_fractional<sanguis::client::draw2d::funit>(life_time_) *
              fcppt::literal<sanguis::client::draw2d::funit>(
                  100.F // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
                  ))});
}

bool sanguis::client::draw2d::entities::text::may_be_removed() const
{
  return life_time_.expired();
}
