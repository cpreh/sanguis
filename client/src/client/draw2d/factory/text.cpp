...
sanguis::client::draw2d::entities::own_unique_ptr sanguis::client::draw2d::factory::text(
...
{
  return fcppt::unique_ptr_to_base<sanguis::client::draw2d::entities::own>(
      fcppt::make_unique_ptr<sanguis::client::draw2d::entities::text>(
          _diff_clock,
          _normal_system,
          _font,
          _text,
