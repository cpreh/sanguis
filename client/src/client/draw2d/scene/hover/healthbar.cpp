...
sanguis::client::health_value remaining_health(sanguis::client::health_pair const _pair)
{
  return _pair.health().get() / _pair.max_health().get();
}
...
sanguis::client::draw2d::scene::hover::healthbar::healthbar(
    ...
    : buffers_{_renderer, sge::sprite::buffers::option::static_},
      range_{sge::sprite::geometry::update(
          sge::sprite::geometry::make_random_access_range(
              std::initializer_list<sanguis::client::draw2d::sprite::colored::object>{
                  sanguis::client::draw2d::sprite::colored::object{
                      sge::sprite::roles::pos{} =
                          _center.get() -
                          fcppt::math::vector::fill<sanguis::client::draw2d::sprite::point>(
                              _radius.get()),
                      sge::sprite::roles::size{} =
                          sanguis::client::draw2d::sprite::dim(_radius.get() * 2, bar_height),
                      sge::sprite::roles::color{} = sge::image::color::convert<
                  ...
                  sanguis::client::draw2d::sprite::colored::object{
                      sge::sprite::roles::pos{} =
                          ...
                          fcppt::math::vector::fill<sanguis::client::draw2d::sprite::point>(
                              _radius.get()) +
                          fcppt::math::dim::fill<sanguis::client::draw2d::sprite::dim>(border_size),
                      sge::sprite::roles::size{} =
                      ...
                      sge::sprite::roles::color{} = sanguis::client::draw2d::sprite::colored::color(
                          (sge::image::color::init::red() %= std::min(
                               fcppt::literal<sanguis::client::health::value_type>(2) -
                                   fcppt::literal<sanguis::client::health::value_type>(2) *
                                       remaining_health(_health_pair),
                               fcppt::literal<sanguis::client::health::value_type>(1)))(
                              sge::image::color::init::green() %= std::min(
                                  fcppt::literal<sanguis::client::health::value_type>(
          ...
          buffers_)},
      state_{_renderer, sge::sprite::state::parameters<state_choices>()}
{
}

sanguis::client::draw2d::scene::hover::healthbar::~healthbar() = default;

void sanguis::client::draw2d::scene::hover::healthbar::draw(
    sge::renderer::context::ffp &_render_context)
{
  sge::sprite::render::range_with_options(
      ...
      range_,
      state_,
      sge::sprite::state::default_options<state_choices>());
}
