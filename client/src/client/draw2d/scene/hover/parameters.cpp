...
sanguis::client::draw2d::scene::hover::parameters::parameters(
    ...
    : gui_style_(_gui_style),
      ...
      player_weapons_(std::move(_player_weapons)),
      center_{_center},
      radius_{_radius}
{
}

sge::gui::style::base const &sanguis::client::draw2d::scene::hover::parameters::gui_style() const
{
  return gui_style_.get();
}

sge::gui::renderer::base &sanguis::client::draw2d::scene::hover::parameters::gui_renderer() const
{
  return gui_renderer_.get();
}

sge::renderer::device::ffp &sanguis::client::draw2d::scene::hover::parameters::renderer() const
{
  return renderer_.get();
}

sge::font::object &sanguis::client::draw2d::scene::hover::parameters::font() const
{
  return font_.get();
}
...
sanguis::client::draw2d::radius sanguis::client::draw2d::scene::hover::parameters::radius() const
{
  return radius_;
}
