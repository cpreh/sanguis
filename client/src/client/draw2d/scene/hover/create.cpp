    ...
    sanguis::client::draw2d::entities::hover::info const &_info)
{
  return fcppt::variant::match(
      ...
      {
        return fcppt::unique_ptr_to_base<sanguis::client::draw2d::scene::hover::base>(
            fcppt::make_unique_ptr<sanguis::client::draw2d::scene::hover::name_and_health>(
                fcppt::make_ref(_parameters.renderer()),
                fcppt::make_ref(_parameters.font()),
                _parameters.center(),
                _parameters.radius(),
                _name_and_health));
      },
      [&_parameters](sanguis::client::draw2d::entities::hover::weapon const &_weapon)
      {
        return fcppt::unique_ptr_to_base<sanguis::client::draw2d::scene::hover::base>(
            fcppt::make_unique_ptr<sanguis::client::draw2d::scene::hover::weapon>(
                fcppt::make_cref(_parameters.gui_style()),
                fcppt::make_ref(_parameters.gui_renderer()),
                fcppt::make_ref(_parameters.renderer()),
                fcppt::make_ref(_parameters.font()),
                _parameters.center(),
                fcppt::make_ref(_parameters.load_context()),
