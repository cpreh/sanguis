...
sanguis::client::draw2d::scene::hover::weapon::weapon(
    ...
    : sanguis::client::draw2d::scene::hover::base{},
      ...
      weapon_attributes_(fcppt::algorithm::map<
          ...
          [this, &_info, &_gui_style, &_renderer, &_font, &_player_weapons](
              sanguis::weapon_attribute const &_attribute)
          {
            return fcppt::make_unique_ptr<sanguis::client::draw2d::scene::hover::weapon_attribute>(
                ...
                sanguis::client::draw2d::scene::hover::compare_weapons(
                    _info.get().weapon_type(), _attribute, _player_weapons));
          })),
      container_(
          fcppt::make_ref(gui_context_),
          fcppt::container::join(
              ...
              fcppt::algorithm::map<sge::gui::widget::reference_alignment_vector>(
                  weapon_attributes_,
                  [](sanguis::client::draw2d::scene::hover::weapon_attribute_unique_ptr const
                         &_attribute)
                  {
                    return sge::gui::widget::reference_alignment_pair{
                        sge::gui::widget::reference{_attribute->widget()},
                        sge::rucksack::alignment::left_or_top};
                  })),
          sge::rucksack::axis::y),
      gui_area_(
          fcppt::reference_to_base<sge::gui::widget::base>(fcppt::make_ref(container_)),
          _center.get()),
      gui_background_(
          fcppt::reference_to_base<sge::gui::main_area::base>(fcppt::make_ref(gui_area_)))
{
}

FCPPT_PP_POP_WARNING

sanguis::client::draw2d::scene::hover::weapon::~weapon() = default;

void sanguis::client::draw2d::scene::hover::weapon::draw(
    sge::renderer::context::ffp &_render_context)
{
  sge::gui::draw(gui_renderer_.get(), _render_context, gui_background_, gui_area_);
}
