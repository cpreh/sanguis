...
sanguis::client::draw2d::translation sanguis::client::draw2d::scene::translation(
    sanguis::client::draw2d::player_center const &_player_center,
    sge::renderer::screen_size const &_screen_size)
{
  return sanguis::client::draw2d::translation(
      -_player_center.get().get() +
      fcppt::math::vector::structure_cast<
          sanguis::client::draw2d::player_center::value_type::value_type,
          fcppt::cast::size_fun>(fcppt::math::vector::to_signed(fcppt::math::dim::to_vector(
          (_screen_size / fcppt::literal<sge::renderer::screen_unit>(2U)).get_unsafe()))));
}
