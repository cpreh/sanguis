...
sanguis::client::draw::base_unique_ptr sanguis::client::draw2d::create(
...
{
  return fcppt::unique_ptr_to_base<sanguis::client::draw::base>(
      fcppt::make_unique_ptr<sanguis::client::draw2d::scene::object>(
          _log_context,
          _load_context,
          _hud_context,
          _sound_manager,
