...
sanguis::client::perk::tree &tree_position(
    sanguis::client::perk::tree &, // NOLINT(google-runtime-references)
    sanguis::optional_perk_type);

}

sanguis::client::perk::tree_unique_ptr sanguis::client::perk::make_tree(
    sanguis::messages::server::types::perk_tree_node_vector const &_list)
{
  ...
  sanguis::client::perk::tree_unique_ptr ret(
      fcppt::make_unique_ptr<sanguis::client::perk::tree>(sanguis::client::perk::optional_info()));

  for (auto const &item : _list)
  {
    ::tree_position(*ret, item.get<sanguis::messages::roles::perk_parent>())
        .push_back(sanguis::client::perk::optional_info(sanguis::client::perk::info(
            item.get<sanguis::messages::roles::perk_label>(),
            sanguis::client::perk::level(
                sanguis::client::level(item.get<sanguis::messages::roles::perk_level>())),
            sanguis::client::perk::required_parent_level(
                sanguis::client::perk::level(sanguis::client::level(
                    item.get<sanguis::messages::roles::required_perk_parent_level>()))),
            sanguis::client::perk::required_player_level(
                sanguis::client::player_level(sanguis::client::level(
                    item.get<sanguis::messages::roles::required_perk_player_level>()))),
            sanguis::client::perk::max_level(sanguis::client::perk::level(
                sanguis::client::level(item.get<sanguis::messages::roles::max_perk_level>()))))));
  }
...
tree_position(sanguis::client::perk::tree &_tree, sanguis::optional_perk_type const _parent_enum)
{
  return fcppt::optional::maybe(
      _parent_enum,
      [&_tree]() -> sanguis::client::perk::tree & { return _tree; },
      [&_tree](sanguis::perk_type const _parent_type) -> sanguis::client::perk::tree &
      {
        return *fcppt::optional::to_exception(
            fcppt::algorithm::find_if_opt(
                fcppt::container::tree::pre_order<sanguis::client::perk::tree>(_tree),
                sanguis::client::perk::compare(_parent_type)),
            [_parent_type]
            {
              return sanguis::exception{
                  FCPPT_TEXT("Can't find tree position of perk ") +
                  sanguis::client::perk::to_string(_parent_type)};
            });
      });
}
