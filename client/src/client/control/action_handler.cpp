...
sanguis::client::control::action_handler::action_handler(
    ...
    : send_(std::move(_send)),
      ...
      rotation_timer_(sanguis::timer::parameters(std::chrono::milliseconds(
          100 // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
          ))),
      direction_(fcppt::math::vector::null<sanguis::client::control::direction_vector>()),
      cursor_position_(),
      cheat_connections_(fcppt::container::make<fcppt::signal::auto_connection_container>(
          this->cheat_connection(
              _console,
              sanguis::cheat_type::auras,
              sge::console::callback::name(SGE_FONT_LIT("auras")),
              sge::console::callback::short_description(SGE_FONT_LIT("Get various auras"))),
          this->cheat_connection(
              _console,
              sanguis::cheat_type::exp,
              sge::console::callback::name(SGE_FONT_LIT("exp")),
              sge::console::callback::short_description(SGE_FONT_LIT("Get a lot of exp"))),
          this->cheat_connection(
              _console,
              sanguis::cheat_type::heal,
              sge::console::callback::name(SGE_FONT_LIT("heal")),
              sge::console::callback::short_description(
                  SGE_FONT_LIT("Completely heal the player"))),
          this->cheat_connection(
              _console,
              sanguis::cheat_type::kill,
              sge::console::callback::name(SGE_FONT_LIT("kill")),
              sge::console::callback::short_description(SGE_FONT_LIT("Commit suicide"))),
          this->cheat_connection(
              _console,
              sanguis::cheat_type::spider,
              sge::console::callback::name(SGE_FONT_LIT("spider")),
              sge::console::callback::short_description(SGE_FONT_LIT("Spawn a spider weapon"))),
          this->cheat_connection(
              _console,
              sanguis::cheat_type::monster_spawner,
              sge::console::callback::name(SGE_FONT_LIT("monster_spawner")),
              sge::console::callback::short_description(
                  SGE_FONT_LIT("Spawn a monster creating weapon"))),
          this->cheat_connection(
              _console,
              sanguis::cheat_type::perks,
              sge::console::callback::name(SGE_FONT_LIT("perks")),
              sge::console::callback::short_description(SGE_FONT_LIT("Get all perks"))),
          this->cheat_connection(
              _console,
              sanguis::cheat_type::sentry,
              sge::console::callback::name(SGE_FONT_LIT("sentry")),
              sge::console::callback::short_description(SGE_FONT_LIT("Spawn a sentry"))),
          this->cheat_connection(
              _console,
              sanguis::cheat_type::grenade,
              sge::console::callback::name(SGE_FONT_LIT("grenade")),
              sge::console::callback::short_description(SGE_FONT_LIT("Spawn a grenade"))),
          this->cheat_connection(
              _console,
              sanguis::cheat_type::shotgun,
              sge::console::callback::name(SGE_FONT_LIT("shotgun")),
              sge::console::callback::short_description(SGE_FONT_LIT("Spawn a shotgun"))),
          this->cheat_connection(
              _console,
              sanguis::cheat_type::rocket_launcher,
              sge::console::callback::name(SGE_FONT_LIT("rocket_launcher")),
              sge::console::callback::short_description(SGE_FONT_LIT("Spawn a rocket launcher")))))
{
}

FCPPT_PP_POP_WARNING

sanguis::client::control::action_handler::~action_handler() = default;

void sanguis::client::control::action_handler::handle_action(
    sanguis::client::control::actions::any const &_action_variant)
{
  fcppt::variant::match(
      _action_variant.get(),
      [this](sanguis::client::control::actions::binary const &_action)
      { this->handle_binary_action(_action); },
      [this](sanguis::client::control::actions::cursor const &_action)
      { this->handle_cursor_action(_action); },
      [this](sanguis::client::control::actions::nullary const &_action)
      { this->handle_nullary_action(_action); },
      [this](sanguis::client::control::actions::scale const &_action)
      { this->handle_scale_action(_action); });
}
    ...
    sanguis::client::control::actions::binary const &_action)
{
  ...
  case sanguis::client::control::actions::binary_type::shoot_primary:
    this->handle_shooting(_action.value(), sanguis::is_primary_weapon(true));
    return;
...
{
  cursor_position_ = _action.position();

  if (!sge::timer::reset_when_expired(fcppt::make_ref(rotation_timer_)))
  {
    return;
  }
  ...
  fcppt::optional::maybe_void(
      ...
      {
        fcppt::optional::maybe_void(
            environment_->translate_attack_dest(_pos),
            [this](sanguis::client::control::attack_dest const &_dest)
            {
              send_(sanguis::messages::client::create(
                  alda::message::init_record<sanguis::messages::client::attack_dest>(
                      sanguis::messages::roles::attack_dest{} = fcppt::math::vector::
    ...
    sanguis::client::control::actions::scale const &_action)
{
  ...
  case sanguis::client::control::actions::scale_type::horizontal_move:
    this->update_direction(fcppt::make_ref(direction_.x()), scale);

    return;
  case sanguis::client::control::actions::scale_type::vertical_move:
    this->update_direction(fcppt::make_ref(direction_.y()), scale);
...
void sanguis::client::control::action_handler::update_direction(
...
void sanguis::client::control::action_handler::handle_shooting(
    bool const _value, sanguis::is_primary_weapon const _is_primary)
{
  if (_value)
  {
    send_(
        sanguis::messages::client::create(sanguis::messages::client::start_shooting{_is_primary}));
  }
  else
  {
    send_(sanguis::messages::client::create(sanguis::messages::client::stop_shooting{_is_primary}));
  }
}

void sanguis::client::control::action_handler::handle_drop(
    sanguis::is_primary_weapon const _is_primary)
{
  send_(sanguis::messages::client::create(
      sanguis::messages::client::drop_or_pickup_weapon{_is_primary}));
}

void sanguis::client::control::action_handler::handle_reload(
    sanguis::is_primary_weapon const _is_primary)
{
  send_(sanguis::messages::client::create(sanguis::messages::client::reload{_is_primary}));
}

void sanguis::client::control::action_handler::send_cheat(
    sanguis::cheat_type const _cheat, sge::console::arg_list const &)
{
  send_(sanguis::messages::client::create(sanguis::messages::client::cheat{_cheat}));
}

fcppt::signal::auto_connection sanguis::client::control::action_handler::cheat_connection(
    sge::console::object_ref const _console,
...
{
  return _console->insert(
      sge::console::callback::parameters(
          sge::console::callback::function{
              [_cheat, this](sge::console::arg_list const &_args, sge::console::object_ref)
              { this->send_cheat(_cheat, _args); }},
          fcppt::copy(_name))
          .short_description(fcppt::copy(_description.get())));
}
