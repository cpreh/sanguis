...
sanguis::client::control::actions::scale::scale(
    ...
    : type_(_type), scale_(_scale)
{
}

sanguis::client::control::actions::scale_type sanguis::client::control::actions::scale::type() const
{
  return type_;
}

sanguis::client::control::key_scale sanguis::client::control::actions::scale::get() const
{
  return scale_;
}
