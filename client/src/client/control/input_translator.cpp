...
sanguis::client::control::actions::scale_type key_scale_type(sge::input::key::code);

sanguis::client::control::key_scale key_scale_value(sge::input::key::code, bool pressed);
...
sanguis::client::control::input_translator::~input_translator() = default;

void sanguis::client::control::input_translator::on_event(sge::input::event_base const &_event)
{
    ...
    sge::input::focus::event::key const &_event)
{
  ...
  case sge::input::key::code::s:
    this->direction_event(_event);
    break;
  case sge::input::key::code::x:
    this->nullary_event(
        _event.pressed(), sanguis::client::control::actions::nullary_type::drop_primary_weapon);
    break;
  case sge::input::key::code::c:
    this->nullary_event(
        _event.pressed(), sanguis::client::control::actions::nullary_type::drop_secondary_weapon);
    break;
  case sge::input::key::code::f1:
    this->nullary_event(_event.pressed(), sanguis::client::control::actions::nullary_type::console);
    break;
  case sge::input::key::code::e:
    this->nullary_event(
        _event.pressed(), sanguis::client::control::actions::nullary_type::perk_menu);
    break;
  case sge::input::key::code::escape:
    this->nullary_event(_event.pressed(), sanguis::client::control::actions::nullary_type::escape);
    break;
  case sge::input::key::code::r:
    this->nullary_event(
        _event.pressed(), sanguis::client::control::actions::nullary_type::reload_primary_weapon);
    break;
  case sge::input::key::code::space:
    this->nullary_event(
        _event.pressed(), sanguis::client::control::actions::nullary_type::change_world);
    break;
  default:
    break;
  }
...
void sanguis::client::control::input_translator::move_event(
    sge::input::cursor::event::move const &_event)
{
  callback_(sanguis::client::control::actions::any(sanguis::client::control::actions::variant(
      sanguis::client::control::actions::cursor(fcppt::optional::map(
          _event.position(),
          [](sge::input::cursor::position const &_position)
          {
            return fcppt::math::vector::
                structure_cast<sanguis::client::control::cursor_position, fcppt::cast::size_fun>(
                    _position);
          })))));
}

void sanguis::client::control::input_translator::button_event(
    sge::input::cursor::event::button const &_event)
{
  FCPPT_PP_PUSH_WARNING
  FCPPT_PP_DISABLE_CLANG_WARNING(-Wswitch-enum)

  switch (_event.button_code())
  {
  case sge::input::cursor::button_code::left:
    this->binary_event(
        _event.pressed(), sanguis::client::control::actions::binary_type::shoot_primary);
    break;
  case sge::input::cursor::button_code::right:
    this->binary_event(
        _event.pressed(), sanguis::client::control::actions::binary_type::shoot_secondary);
    break;
  default:
    break;
  }
...
void sanguis::client::control::input_translator::direction_event(
    sge::input::focus::event::key const &_event)
{
  callback_(sanguis::client::control::actions::any(
      sanguis::client::control::actions::variant(sanguis::client::control::actions::scale(
          ::key_scale_type(_event.get().code()),
          ::key_scale_value(_event.get().code(), _event.pressed())))));
}

void sanguis::client::control::input_translator::nullary_event(
    bool const _pressed, sanguis::client::control::actions::nullary_type const _action)
{
  if (!_pressed)
  {
    return;
  ...
  callback_(sanguis::client::control::actions::any(sanguis::client::control::actions::variant(
      sanguis::client::control::actions::nullary(_action))));
}

void sanguis::client::control::input_translator::binary_event(
    bool const _pressed, sanguis::client::control::actions::binary_type const _action)
{
  callback_(sanguis::client::control::actions::any(sanguis::client::control::actions::variant(
      sanguis::client::control::actions::binary(_action, _pressed))));
}

namespace
{

sanguis::client::control::actions::scale_type key_scale_type(sge::input::key::code const _code)
{
  FCPPT_PP_PUSH_WARNING
  FCPPT_PP_DISABLE_CLANG_WARNING(-Wswitch-enum)
  switch (_code)
...
key_scale_value(sge::input::key::code const _code, bool const _pressed)
{
  sanguis::client::control::key_scale const scale(
      _pressed ? sanguis::client::control::axis_direction_max()
