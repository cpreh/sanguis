...
#include <sanguis/client/draw2d/sprite/type_choices.hpp> // IWYU pragma: keep
#include <sanguis/client/draw2d/sprite/normal/choices_fwd.hpp> // IWYU pragma: export
#include <sge/sprite/config/choices.hpp> // IWYU pragma: keep
#include <sge/sprite/config/intrusive.hpp> // IWYU pragma: keep
...
#include <sge/sprite/config/with_color.hpp> // IWYU pragma: keep
#include <sge/sprite/config/with_rotation.hpp> // IWYU pragma: keep
