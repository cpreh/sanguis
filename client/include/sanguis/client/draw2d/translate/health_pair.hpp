...
sanguis::client::health_pair health_pair(alda::message::object<Id, Type> const &_message)
{
  return sanguis::client::health_pair(
      sanguis::client::health(fcppt::record::get<sanguis::messages::roles::health>(_message.get())),
