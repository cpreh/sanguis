...
public:
  ...
  [[nodiscard]] sanguis::client::draw2d::insert_own_callback const &insert_own_callback() const;

  [[nodiscard]] sanguis::client::draw2d::entities::load_parameters const &load_parameters() const;

  [[nodiscard]] sanguis::creator::optional_background_tile background_tile() const;
