...
public:
  ...
  [[nodiscard]] sanguis::client::draw2d::entities::load_parameters const &load_parameters() const;

  [[nodiscard]] sanguis::load::model::path const &path() const;

  [[nodiscard]] sanguis::client::draw2d::entities::order_function const &order_function() const;

  [[nodiscard]] sanguis::client::optional_health_pair const &health_pair() const;

  [[nodiscard]] sanguis::client::draw2d::entities::model::decay_option decay_option() const;
  ...
  [[nodiscard]] sanguis::client::draw2d::sprite::rotation rotation() const;
