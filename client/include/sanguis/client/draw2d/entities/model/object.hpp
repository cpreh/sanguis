...
class object : public sanguis::client::draw2d::entities::container,
...
public:
  using parameters_type = sanguis::client::draw2d::entities::model::parameters;

  explicit object(sanguis::client::draw2d::entities::model::parameters const &);
...
protected:
  ...
  void orientation(
      sanguis::client::draw2d::sprite::rotation, sanguis::client::draw2d::sprite::index);
...
private:
  ...
  void change_animation(sanguis::client::load::animation_type);

  [[nodiscard]] sanguis::client::load::animation_type animation() const;

  [[nodiscard]] sanguis::client::load::animation_type
      fallback_anim(sanguis::client::load::animation_type) const;

  [[nodiscard]] bool animations_ended() const;
  ...
  using optional_decay_time =
      fcppt::optional::object<sanguis::client::draw2d::entities::model::decay_time>;
