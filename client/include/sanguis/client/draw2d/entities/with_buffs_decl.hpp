...
class with_buffs : public sanguis::client::draw2d::entities::ifaces::with_buffs, public Base
{
...
public:
  ...
  explicit with_buffs(parameters_type const &);
...
private:
  ...
  using buff_map =
      std::map<sanguis::buff_type, sanguis::client::draw2d::entities::buffs::unique_ptr>;
