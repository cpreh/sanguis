...
#include <sanguis/client/draw2d/entities/with_auras_model_parameters_fwd.hpp> // IWYU pragma: export
...
extern template class sanguis::client::draw2d::entities::with_auras_parameters<
