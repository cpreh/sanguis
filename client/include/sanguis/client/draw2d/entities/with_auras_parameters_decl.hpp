...
#include <sanguis/client/draw2d/entities/with_auras_parameters_fwd.hpp> // IWYU pragma: keep
...
public:
  ...
  [[nodiscard]] sanguis::client::load::auras::context &aura_load_context() const;

  [[nodiscard]] sanguis::client::draw2d::sprite::normal::system &normal_system() const;

  [[nodiscard]] sanguis::aura_type_vector const &auras() const;
