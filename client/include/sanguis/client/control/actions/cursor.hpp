...
#include <sanguis/client/control/actions/cursor_fwd.hpp> // IWYU pragma: keep
...
{
public:
  explicit cursor(sanguis::client::control::optional_cursor_position);

  [[nodiscard]] sanguis::client::control::optional_cursor_position position() const;
