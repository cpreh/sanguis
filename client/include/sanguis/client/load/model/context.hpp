...
public:
  [[nodiscard]] sanguis::client::load::model::collection const &operator()() const;

private:
  friend class sanguis::client::load::context;

  context(fcppt::log::context_reference, sanguis::client::load::resource::context_cref);

  ~context();

  fcppt::unique_ptr<sanguis::client::load::model::collection> const collection_;
};
