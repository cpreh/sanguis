...
class base : public sanguis::client::control::environment
{
...
public:
  ...
  virtual void process_message(sanguis::messages::server::base const &) = 0;

  virtual void update(
      sanguis::client::slowed_duration,
      sanguis::client::control::optional_cursor_position const &) = 0;

  virtual void draw(sge::renderer::context::ffp & // NOLINT(google-runtime-references)
                    ) = 0; // NOLINT(google-runtime-references)

  virtual void overlay(sge::renderer::context::ffp & // NOLINT(google-runtime-references)
                       ) = 0; // NOLINT(google-runtime-references)
