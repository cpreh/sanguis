    ...
    sanguis::client::dispatch_default_function const &_handle_default_msg)
{
  ...
  static sanguis::messages::server::call::object<MessageTypes, State> dispatcher{};

  FCPPT_PP_POP_WARNING

  return sanguis::messages::call::dispatch(dispatcher, _state, _message, _handle_default_msg);
}
