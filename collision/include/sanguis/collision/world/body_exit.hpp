...
#include <sanguis/collision/world/body_exit_fwd.hpp> // IWYU pragma: keep
...
{
public:
  body_exit(sanguis::collision::world::body_base_ref, sanguis::collision::world::ghost_base_ref);
