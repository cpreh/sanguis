...
sanguis::collision::aux::world::simple::body::body(
	...
	sanguis::collision::aux::world::simple::body_remove_callback const &_body_remove_callback
)
:
...
void
sanguis::collision::aux::world::simple::body::center(
...
sanguis::collision::aux::world::simple::body::center() const
{
	return
		center_;
}
...
void
sanguis::collision::aux::world::simple::body::speed(
...
sanguis::collision::aux::world::simple::body::speed() const
{
	return
		speed_;
}
...
sanguis::collision::aux::world::simple::body::radius() const
{
	return
		radius_;
}
...
sanguis::collision::aux::world::simple::body::collision_groups() const
{
	return
		collision_groups_;
}
...
sanguis::collision::aux::world::simple::body::body_base() const
{
	return
		body_base_;
}
