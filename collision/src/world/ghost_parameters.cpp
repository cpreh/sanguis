...
sanguis::collision::world::ghost_parameters::ghost_parameters(
    ...
    : center_(std::move(_center)),
      ...
      ghost_base_(_ghost_base)
{
}

sanguis::collision::center sanguis::collision::world::ghost_parameters::center() const
{
  return center_;
}

sanguis::collision::radius sanguis::collision::world::ghost_parameters::radius() const
{
  return radius_;
}
