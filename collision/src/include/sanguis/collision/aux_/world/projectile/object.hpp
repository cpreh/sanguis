#ifndef SANGUIS_COLLISION_AUX__WORLD_PROJECTILE_OBJECT_HPP_INCLUDED
#define SANGUIS_COLLISION_AUX__WORLD_PROJECTILE_OBJECT_HPP_INCLUDED
...
private:
	...
	sanguis::collision::aux_::world::projectile::global_groups const global_groups_;
};
